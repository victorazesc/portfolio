    ...
    <div className="w-full h-full justify-between items-center inline-flex md:flex-row flex-col-reverse mt-36 overflow-hidden">
      <div className="w-full self-stretch pt-16 pb-16 flex-col justify-between items-start gap-4 inline-flex z-20">
        <div className="pt-2 pb-2 flex flex-col justify-between leading-5 items-start">
          <div className="text-lg text-justify text-white opacity-70 font-light">
            VICTOR AZEVEDO
          </div>
          <div>
            <h1 className="text-[2.5rem] text-purple-600 font-semibold leading-[65px]">
              Engenheiro de software <span className="text-white">e desenvolvedor</span> fullstack
            </h1>
          </div>
        </div>
        <div className="pt-3 pb-3 pr-20 justify-start items-start gap-4 inline-flex">
          <div className="text-white text-lg font-light leading-8">
